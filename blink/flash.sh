...
#../avrdude/avrdude -C -p m328p -c usbasp -U flash:w:main.hex:i -U lfuse:w:0xFF:m -U hfuse:w:0xDE:m -U efuse:w:0x05:m 
avrdude -p m328p -c usbasp -U flash:w:main.hex -U lfuse:w:0xFF:m -U hfuse:w:0xDE:m -U efuse:w:0x05:m
